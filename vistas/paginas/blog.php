        ...
        <div class="row g-4">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="blog__items">
                    ...
                    <div class="blog__content">
                        <h4>
                            <a href="index.php?pagina=service-single">top 10 gifts</a>
                        </h4>
                        <p>
                        ...
                        <div class="blog-button mt-2">
                            <a href="index.php?pagina=service-single" class="blog-btn">read more</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="blog__items">
                    ...
                    <div class="blog__content">
                        <h4>
                            <a href="index.php?pagina=service-single">Best Photography Idea</a>
                        </h4>
                        <p>
                            The tradition is based on an Old English rhyme that dates back to 19th-century Lancashire.It describes the items a bride should have on her wedding day.
                        </p>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="blog__items">
                    ...
                    <div class="blog__content">
                        <h4>
                            <a href="index.php?pagina=service-single">Wedding Flower Collect</a>
                        </h4>
                        <p>
                            The tradition is based on an Old English rhyme that dates back to 19th-century Lancashire.It describes the items a bride should have on her wedding day.
                        </p>
